...
return {
  ...
  sequences = {
    ...
    {loopCount = 0, time = 240, frames = {7, 8, 9}, name = "up"},
    {loopCount = 0, time = 240, frames = {10, 11, 12}, name = "left"},
    {loopCount = 0, time = 240, frames = {13, 14}, name = "lose"},
    {loopCount = 0, time = 240, frames = {15, 16}, name = "win"},
  }
}